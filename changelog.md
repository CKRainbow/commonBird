## v0.11.0
* 修复了热点名称完全相同导致部分热点被忽略的问题（会导致之前的地点分配记录部分丢失）
* 修复了无法转换澳门记录的问题

## v0.10.3
* 紧急修复了由于 rich 库更新导致的问题
...
* 更完善的API异常处理以及UI层处理
* 添加了 API 异常处理的测试
* [修复当从观鸟记录中心获取点位坐标时若请求异常程序会崩溃的问题](https://github.com/CKRainbow/commonBird/pull/2)

## v0.9.5
* 修复了对于台湾省的记录处理时会崩溃的问题
* 优化了异常日志的记录，方便后续调试

## v0.9.4
* 错误处理更全面，避免在某些情况下导致软件直接崩溃
* 改善了部分提示
